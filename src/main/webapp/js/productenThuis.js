...
function populateDropdown() {
    ...
    fetch('https://tests-1718633149689.azurewebsites.net/eet-share/producten', {
        method: 'GET',
        headers: {
...
function postValues(values) {
    values.forEach(({ product, quantity, location }) => {
        ...
        fetch("https://tests-1718633149689.azurewebsites.net/eet-share/productenthuis/testing", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
...
function getProductenInHuis() {
    ...
    fetch('https://tests-1718633149689.azurewebsites.net/eet-share/productenthuis/ophalen', {
        method: 'GET',
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
